...
const sidebarIcons: Record<string, ReactNode> = {
  ...
  routing: <IconRoute size={18} />,
  rateLimits: <IconGauge size={18} />,
...
export function MainLayout() {
  ...
  const navItems = [
    ...
    { path: '/routing', label: t('nav.routing'), icon: sidebarIcons.routing },
    { path: '/rate-limits', label: t('nav.rate_limits'), icon: sidebarIcons.rateLimits },
